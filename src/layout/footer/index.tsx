...
export const Footer = () => {
  return (
    <footer className="bg-black text-white py-10 px-6 md:px-20 text-[15px]">
      <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr_1fr] gap-12">
        {/* Cột 1: Logo + Mạng xã hội + Địa chỉ */}
        <div>
          <Image
            src="/assets/images/logo-115x80.png"
            width={115}
            height={80}
            alt="Logo"
            className="mb-6"
          />
          <div className="flex gap-4 text-xl text-[#ffb700] mb-6">
            <FacebookFilled />
            <YoutubeFilled />
            <TikTokOutlined />
            <MediumSquareFilled />
          ...
          <div className="space-y-2 text-sm leading-relaxed">
            ...
            <p>
              ...
              50 đường Lê Trọng Tấn, Dương Nội, Hà Đông, Hà Nội
            </p>
            <p>
              <strong className="text-[#00B2FF]">Tổng kho TP.HCM:</strong> Dự án
              Dragon Village – Đường Đặng Thanh Hiếu – TP Thủ Đức – TP Hồ Chí
              Minh
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <h4 className="font-bold mb-3 text-[#ffb700]">Về chúng tôi</h4>
          ...
          <div>
            <h4 className="font-bold mb-3 text-[#ffb700]">Thông tin hữu ích</h4>
            <ul className="space-y-2">
              <li>
                <Link
          ...
          <div>
            <h4 className="font-bold mb-3 text-[#ffb700]">Sản phẩm nổi bật</h4>
            <ul className="space-y-2">
              <li>
                <Link
        ...
        <div className="space-y-4 text-sm">
          ...
          <div className="flex items-center gap-2 text-[#ffb700] text-lg font-semibold">
            <PhoneFilled />
